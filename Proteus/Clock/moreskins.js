CoolClock.config.skins = {
	...
	modern/*was gIG2*/: {
		outerBorder:      { lineWidth: 185, radius: 1, color: "#E5ECF9", alpha: 1 },
		smallIndicator:   { lineWidth: 5, startAt: 88, endAt: 94, color: "#ffffff", alpha: 1 },
		largeIndicator:   { lineWidth: 5, startAt: 88, endAt: 94, color: "#ffffff", alpha: 1 },
		hourHand:         { lineWidth: 8, startAt: 0, endAt: 60, color: "white", alpha: 1 },
		minuteHand:       { lineWidth: 8, startAt: 0, endAt: 80, color: "white", alpha: 1 },
		secondHand:       { lineWidth: 5, startAt: 80, endAt: 85, color: "white", alpha: .85 },
		secondDecoration: { lineWidth: 3, startAt: 0, radius: 4, fillColor: "white", color: "white", alpha: 1 }
	},
