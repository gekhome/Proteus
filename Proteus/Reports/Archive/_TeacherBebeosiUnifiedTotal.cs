namespace Proteus.Reports.Archive
{
    ...
    /// </summary>
    public partial class _TeacherBebeosiUnifiedTotal : Telerik.Reporting.Report
    {
        public _TeacherBebeosiUnifiedTotal()
        {
            //
        ...
        private void txtSumHours_ItemDataBound(object sender, System.EventArgs e)
        {
            Telerik.Reporting.Processing.TextBox text1 = (Telerik.Reporting.Processing.TextBox)sender;
            ...
            this.txtTotalHoursWord.Value = HoursWord;
        }
